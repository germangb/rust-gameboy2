                        ...
                        0x10..=0x1f => match opcode {
                            ...
                            0x16 => {
                                ...
                                <D as MemoryBus>::write(
                                    memory,
                                    hl,
                                    self.rl_n(<D as MemoryBus>::read(memory, hl)?),
                                )?
                            }
                            ...
                            0x1e => {
                                ...
                                <D as MemoryBus>::write(
                                    memory,
                                    hl,
                                    self.rr_n(<D as MemoryBus>::read(memory, hl)?),
                                )?
                            }
                        ...
                        0x20..=0x2f => match opcode {
                            ...
                            0x26 => {
                                ...
                                <D as MemoryBus>::write(
                                    memory,
                                    hl,
                                    self.sla_n(<D as MemoryBus>::read(
                                        memory,
                                        self.registers.hl(),
                                    )?),
                                )?
                            ...
                            0x2e => {
                                ...
                                <D as MemoryBus>::write(
                                    memory,
                                    hl,
                                    self.sra_n(<D as MemoryBus>::read(
                                        memory,
                                        self.registers.hl(),
                                    )?),
                                )?
                        ...
                        0x30..=0x3f => match opcode {
                            ...
                            0x3e => {
                                ...
                                <D as MemoryBus>::write(
                                    memory,
                                    hl,
                                    self.srl_n(<D as MemoryBus>::read(
                                        memory,
                                        self.registers.hl(),
                                    )?),
                                )?
                ...
                0x40..=0x7f => match opcode {
                    0x40..=0x5f => match opcode {
                        0x40..=0x4f => match opcode {
                            ...
                            0x46 => self
                                .bit_b_n(0, <D as MemoryBus>::read(memory, self.registers.hl())?),
                            ...
                            0x4e => self
                                .bit_b_n(1, <D as MemoryBus>::read(memory, self.registers.hl())?),
                        ...
                        0x50..=0x5f => match opcode {
                            ...
                            0x56 => self
                                .bit_b_n(2, <D as MemoryBus>::read(memory, self.registers.hl())?),
                            ...
                            0x5e => self
                                .bit_b_n(3, <D as MemoryBus>::read(memory, self.registers.hl())?),
                    ...
                    0x60..=0x7f => match opcode {
                        0x60..=0x6f => match opcode {
                            ...
                            0x66 => self
                                .bit_b_n(4, <D as MemoryBus>::read(memory, self.registers.hl())?),
                            ...
                            0x6e => self
                                .bit_b_n(5, <D as MemoryBus>::read(memory, self.registers.hl())?),
                        ...
                        0x70..=0x7f => match opcode {
                            ...
                            0x76 => self
                                .bit_b_n(6, <D as MemoryBus>::read(memory, self.registers.hl())?),
                            ...
                            0x7e => self
                                .bit_b_n(7, <D as MemoryBus>::read(memory, self.registers.hl())?),
                        ...
                        0x80..=0x8f => match opcode {
                            ...
                            0x86 => {
                                ...
                                <D as MemoryBus>::write(
                                    ...
                                    self.res_b_n(
                                        0,
                                        <D as MemoryBus>::read(memory, self.registers.hl())?,
                                    ),
                                )?
                            }
            ...
            0x00..=0x7f => match opcode {
                0x00..=0x3f => match opcode {
                    0x00..=0x1f => match opcode {
                        0x00..=0x0f => match opcode {
                            ...
                            0x0a => {
                                self.registers.a =
                                    <D as MemoryBus>::read(memory, self.registers.bc())?
                            }
                            0x0b => {
                        ...
                        0x10..=0x1f => match opcode {
                            ...
                            0x1a => {
                                self.registers.a =
                                    <D as MemoryBus>::read(memory, self.registers.de())?
                            }
                            0x1b => {
                ...
                0x40..=0x7f => match opcode {
                    ...
                    0x60..=0x7f => match opcode {
                        ...
                        0x70..=0x7f => match opcode {
                            0x70 => <D as MemoryBus>::write(
                                memory,
                                self.registers.hl(),
                                self.registers.b,
                            )?,
                            0x71 => <D as MemoryBus>::write(
                                memory,
                                self.registers.hl(),
                                self.registers.c,
                            )?,
                            0x72 => <D as MemoryBus>::write(
                                memory,
                                self.registers.hl(),
                                self.registers.d,
                            )?,
                            0x73 => <D as MemoryBus>::write(
                                memory,
                                self.registers.hl(),
                                self.registers.e,
                            )?,
                            0x74 => <D as MemoryBus>::write(
                                memory,
                                self.registers.hl(),
                                self.registers.h,
                            )?,
                            0x75 => <D as MemoryBus>::write(
                                memory,
                                self.registers.hl(),
                                self.registers.l,
                            )?,
                            0x76 => self.halt = true,
                            0x77 => <D as MemoryBus>::write(
                                memory,
                                self.registers.hl(),
                                self.registers.a,
                            )?,
                ...
                0x80..=0xbf => match opcode {
                    0x80..=0x9f => match opcode {
                        0x80..=0x8f => match opcode {
                            ...
                            0x86 => {
                                self.add_n(<D as MemoryBus>::read(memory, self.registers.hl())?)
                            }
                            ...
                            0x8e => {
                                self.adc_n(<D as MemoryBus>::read(memory, self.registers.hl())?)
                            }
                        ...
                        0x90..=0x9f => match opcode {
                            ...
                            0x96 => {
                                self.sub_n(<D as MemoryBus>::read(memory, self.registers.hl())?)
                            }
                            ...
                            0x9e => {
                                self.sbc_n(<D as MemoryBus>::read(memory, self.registers.hl())?)
                            }
                    ...
                    0xa0..=0xbf => match opcode {
                        0xa0..=0xaf => match opcode {
                            ...
                            0xa6 => {
                                self.and_n(<D as MemoryBus>::read(memory, self.registers.hl())?)
                            }
                            ...
                            0xae => {
                                self.xor_n(<D as MemoryBus>::read(memory, self.registers.hl())?)
                            }
                ...
                0xc0..=0xff => match opcode {
                    ...
                    0xe0..=0xff => match opcode {
                        ...
                        0xf0..=0xff => match opcode {
                            ...
                            0xf2 => {
                                self.registers.a = <D as MemoryBus>::read(
                                    memory,
                                    0xff00 + u16::from(self.registers.c),
                                )?
                            }
